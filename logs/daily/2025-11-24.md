...
- Similar results to previous → NOT an encoder problem
...
|-------|--------|----------|--------|-----------|-------|
| 50 | click fade to silence | similar | noise | 6.7→6.6 | grad norm not clipping |
...
|-------|-----------|-------|
| 100 | 6.75→6.6 | much smoother loss, max gradient 0.5, noisy samples |
| 200 | 6.76 | |
| 300 | 7 | pure noise |
| 400 | 7.4 | pure noise |
...
**Results:**
- Epoch 100: eval 6.75→6.67, smooth train loss, temp=0 quiet buzzing, rest quiet noise
